#!/usr/bin/env python2
# a simplified version generated from the powerful QC part of kundaje atac pipeline
# ref. https://github.com/kundajelab/atac_dnase_pipelines
...
def parse_args():
    ...
    parser.add_argument('--threads', help='Threads to use')
...
def main():
    ...
    # Parse args
    [NAME, OUTPUT_PREFIX, TSS, CHROMSIZES, FINAL_BAM, THREADS] = parse_args()
